...
$config['site_file'] = 'www_motors_biz_com';
$config['admin_site_file'] = 'admin_motors_biz_com';
$config['company_site_file'] = 'company_motors_biz_com';

$config['main_path'] = '/webimage/img/';
$config['img_rootpath'] = $config['main_path'].$config['site_file'].'/public_html';
$config['img_path'] = '/upload/user/'; // Relative to domain name
$config['upload_path'] = $config['img_rootpath'].$config['img_path']; // Physical path. [Usually works fine like this]
